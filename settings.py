...
item_xpos_offset = 50
item_ypos_offset = 30
item1_xpos = item_xpos_offset + 260         # item 1 = header
item1_ypos = item_ypos_offset * 1
item2_xpos = item_xpos_offset + 160         # item 2 = file read status successfull
item2_ypos = item_ypos_offset * 1.8
item3_xpos = item_xpos_offset + 160         # item 3 = error message
